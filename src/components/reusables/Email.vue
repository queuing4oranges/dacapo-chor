<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 800.496 394.305" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" artist="Katerina Limpitsouni" source="https://undraw.co/">
        <g transform="translate(-0.005)">
            <path d="M800.484,435.838a1.783,1.783,0,0,1-1.8,1.451H1.775a1.747,1.747,0,0,1-1.748-1.405,1.689,1.689,0,0,1,1.667-1.973H798.817A1.683,1.683,0,0,1,800.484,435.838Z" transform="translate(0 -42.984)" fill="#023f31"/>
            <path d="M752.234,387.232H277.44V76.66a17.391,17.391,0,0,1,17.37-17.37H734.864a17.391,17.391,0,0,1,17.37,17.37V387.232Z" transform="translate(-27.483 -5.873)" fill="#023f31"/>
            ...
            <path d="M89.9,81.728l26.118,8.388,11.018,25.217,6,11a12.86,12.86,0,0,1-2.2,15.253l-3.8,3.8,5.307,19.451-49.525-1.766-3.144-44.02a27.677,27.677,0,0,1,1.351-10.739l8.865-26.6Z" transform="translate(-7.885 -8.094)" fill="#21b98d"/>
            <path d="M119.208,122.56v97.373H98.838L92.82,123.38" transform="translate(-9.194 -12.141)" fill="#21b98d"/>
            <path d="M84.674,80.7s.964,7.343,9.937,7.586l18.19.487s-15.379-37.425-9.054-33.209,23.19-13.46,23.19-13.46l4.973,9.334s11.883-4.306-1.288-14.847c0,0-15.721-12.154-32.407-4.856S84.674,80.7,84.674,80.7Z" transform="translate(-8.364 -2.912)" fill="#023f31"/>
            ...
            <circle cx="39.939" cy="39.939" r="39.939" transform="translate(486.012 34.884)" fill="#21b98d"/>
            ...
            <path d="M47.615.75H0V-.75H47.615Z" transform="translate(399.999 99.932)" fill="#023f31"/>
            <path d="M166.259.75H0V-.75H166.259Z" transform="translate(399.999 137.952)" fill="#023f31"/>
            <path d="M166.259.75H0V-.75H166.259Z" transform="translate(399.999 175.971)" fill="#023f31"/>
        </g>
    </svg>
</template>
...
// #090814 dark blue - exchange with this: #023f31
// #ccc9dd grey-ish
// #e49497 skin color
// #fff weiß
// #6c63ff lighter blues - exchange - #21b98d
