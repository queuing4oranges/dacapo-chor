<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 800.496 394.305" role="img">
        <g transform="translate(-0.005)">
            ...
            <path d="M89.9,81.728l26.118,8.388,11.018,25.217,6,11a12.86,12.86,0,0,1-2.2,15.253l-3.8,3.8,5.307,19.451-49.525-1.766-3.144-44.02a27.677,27.677,0,0,1,1.351-10.739l8.865-26.6Z" transform="translate(-7.885 -8.094)" class="hover-fill"/>
            <path d="M119.208,122.56v97.373H98.838L92.82,123.38" transform="translate(-9.194 -12.141)" class="hover-fill"/>
            ...
            <circle cx="39.939" cy="39.939" r="39.939" transform="translate(486.012 34.884)"  class="hover-fill"/>
...
// #e49497 skin color 
// #fff weiß
// #6c63ff lighter blues - exchange - #046b52
